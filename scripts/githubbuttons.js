...
!function() {
    ...
    var e = window.document
      ...
      , A = function(e, t, o) {
        ...
        if (f.length < l.length || ("." + f).substring(f.length - l.length) !== "." + l)
            return c.removeAttribute("href"),
            void o(d);
        var h = (" /" + c.pathname).split(/\/+/);
        if (((f === l || f === "gist." + l) && "archive" === h[3] || f === l && "releases" === h[3] && ("download" === h[4] || "latest" === h[4] && "download" === h[5]) || f === "codeload." + l) && (c.target = "_top"),
        "true" === w(t["data-show-count"]) && f === l) {
            var u, g;
            if (!h[2] && h[1])
                g = "followers",
                u = "?tab=followers";
    ...
    t.protocol + "//" + t.host + t.pathname === i ? A(e.body, s(window.name || t.hash.replace(/^#/, "")), (function() {}
    )) : function(t) {
        if ("complete" === e.readyState || "loading" !== e.readyState && !e.documentElement.doScroll)
            setTimeout(t);
        else if (e.addEventListener) {
            var o = v(t);
            u(e, "DOMContentLoaded", o),
            u(window, "load", o)
        } else
            g(e, /m/, t)
    }((function() {
